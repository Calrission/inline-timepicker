...
async def handle_timepicker(query: CallbackQuery, callback_data: TimepickerCallback):
    ...
    is_continue, handle_result = inline_timepicker.handle(query.from_user.id, callback_data)
    ...
    elif not is_continue:   # Cancel pressed
...
async def main() -> None:
    ...
    bot = Bot("7327799319:AAF3avmf9E8TZRdsn6jqqma0-7QxB8ugqeY", default=DefaultBotProperties(parse_mode=ParseMode.HTML))  # works from aiogram v.3.7.0
